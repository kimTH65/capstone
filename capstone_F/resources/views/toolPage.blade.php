  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><button type="button" class="btn btn-info" onclick="createImage()">Image Upload</button></li>
        <li><button id = "btnScreenShot" type="button" class="btn btn-success" style = "width : 185px;">Image Capture</button></li>
       <a class="demo-1 btn btn-primary" style = "margin-top:5px;margin-left:3px; margin-bottom:7px;" data-content="Lorem ipsum dolor sit amet, consectetur adipiscing elit. ">Save Image</a>
