...
<div id="jb-container" class="col-md-7">
  ...
  @foreach ($d_pages as $d_page)
     <div class="row" style = "float:left; margin-left:10px; width:300px;">
    ...
    <a href = "{{ route('design_read', ['d_page' => $d_page->id]) }}"<p><img src="design_image/{{ $d_page->id }}/main_image.jpg" style = "width:242px;height:220px;margin-top:10px;"></p></a>
            ...
            <div class="caption">
                ...
                <a href = "{{ route('design_vector', ['user_id'=>$_SESSION['id'],'d_page' => $d_page->id,'vector_score' => $d_page->vector, 'score' => 0  ])}}"><button type="button" class="btn btn-primary">싫어요</button></a>
                <!-- ---------new -->
            </div>
            </div>
        </div>
