...
@section('contents')
   <div class="Title_img">
        <img src="../template1/title_image.jpg" alt="test" style = "width:100%; height:300px;" >
            <div class="content">
            <h1 id = "title_name" style = "display:inline">{{$template_user->template_title_text }}</h1><small id = "st_title" style = "font-size:20px;color:#999999;">{{$template_user->template_title_small }}</small>
            </div>
            <div class = "content2">
            <h1 id = "top_title">{{$template_user->template_title }}</h1>
            </div>
        ...
        <textarea id = "info_name" rows="8" cols="65" style="border:0;  font-size:20px;" readonly>{{$template_user->template_info_text }}</textarea>
        </div>
