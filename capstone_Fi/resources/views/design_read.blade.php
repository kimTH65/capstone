...
@section('contents')
    <div id="jb-container">
        ...
        <a href = "{{ route('design_read', ['d_page' => $rank[$i]]) }}">
            <img class="jumbotron" src="/design_image/<?php echo $rank[$i]?>/main_image.jpg" alt="..."style = "width:310px; height:330px;background-color:#FFFFFF;float:left;margin-left:15px;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';"   >
        </a>
        <?php 
        }
        ?>
