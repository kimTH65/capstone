...
@section('contents')
  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <br><br><br><br>
        <div id="text-body">
        <form action = "/comment_process" method = "POST" class="form-horizontal" role="form"  enctype="multipart/form-data"> 
            {{ csrf_field() }}
            ...
            <div class="form-group"> 
                 <label for="author" class="col-sm-2 control-label">내용</label>
                    <div class="col-sm-10"> 
                    <textarea class="form-control" rows="20" name = "description" style = "width:700px; background-color:white;" readonly>{{ $page->content }}</textarea>
                    </div>
            </div>
         <img src="/board_image/{{ $page->id }}/1.jpg" alt="..." class="img-thumbnail" style = "width:242px;height:220px;margin-left:130px;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';">
                     <br><br>
           ...
           @foreach ($reply as $replys)
                <label for="comment" class="col-sm-2 control-label">{{ $replys->name }}</label>
                      <div class="col-sm-10"> 
                        ...
                        <textarea class="form-control" rows="4" style = "width:500px;background-color:white;border:none;resize: none;box-shadow: 0px 0px 2px rgba(0,0,0,.8);" readonly>{{ $replys->content }}</textarea>
