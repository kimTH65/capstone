...
<div>
    <div id="jb-container"  >
        ...
        <img src="/design_image/{{ $d_page->id }}/main_image.jpg" alt="..." style = "width:100%;height:400px;" class="big">
        <br>
        <br>
        <br>
        ...
        <hr>
        <h2>제작한 디자인</h2>
        <img src="/design_image/{{ $d_page->id }}/sub_image1.jpg" alt="..." class="img-thumbnail" style = "width:242px;height:220px;" class="big">
        <img src="/design_image/{{ $d_page->id }}/sub_image2.jpg" alt="..." class="img-thumbnail" style = "width:242px;height:220px;" class="big">
        <img src="/design_image/{{ $d_page->id }}/sub_image3.jpg" alt="..." class="img-thumbnail" style = "width:242px;height:220px;" class="big">
        <img src="/design_image/{{ $d_page->id }}/sub_image4.jpg" alt="..." class="img-thumbnail" style = "width:242px;height:220px;" class="big">
