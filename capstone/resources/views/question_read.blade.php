...
@section('contents')
    <middle>
        <div id="jb-container">
    <p style="font-size:5rem; font-weight:bolder;text-align:center;"> 문의 게시판</p>
    <img src="../main_img/문의게시판.jpg" alt = "문의게시이미지" style = "width:900px;">
        ...
        <?php }?>
            ...
            ?>
             <div class="form-group">
                ...
                <a href = "{{ route('design_update', ['q_page' => $q_page->id]) }}"<button type="button" class="btn btn-primary">글 수정</button></a>
                     <a href = "{{ route('design_delete', ['q_page' => $q_page->id]) }}"><button type="button" class="btn btn-danger">글 삭제</button></a>
