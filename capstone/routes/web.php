...
Route::any('/template_page/TemplatePage_1','TemplateTableController@TemplatePage_1');
Route::any('/template_page/TemplatePage_upload','TemplateTableController@TemplatePage_upload');
...
//------new
Route::any('/design_vector','DesignBoardController@design_vector')->name('design_vector'); // 백터