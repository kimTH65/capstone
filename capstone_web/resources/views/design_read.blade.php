...
<div class="container marketing">
    <div id="">
        ...
        <img src="/design_image/{{ $d_page->id }}/main_image.jpg" alt="..." style = "width:100%;height:60%;">
        <br>
        <br>
        <br>
        ...
        <img src="/design_image/{{ $d_page->id }}/sub_image1.jpg" alt="..." class="img-thumbnail" style = "width:24%;height:24%;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';">
        <img src="/design_image/{{ $d_page->id }}/sub_image2.jpg" alt="..." class="img-thumbnail" style = "width:24%;height:24%;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';">
        <img src="/design_image/{{ $d_page->id }}/sub_image3.jpg" alt="..." class="img-thumbnail" style = "width:24%;height:24%;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';">
        <img src="/design_image/{{ $d_page->id }}/sub_image4.jpg" alt="..." class="img-thumbnail" style = "width:24%;height:24%;" onerror="this.onerror=null; this.src='/board_image/default_image.jpg';">

        
        <br><br>
        <h2 style = "text-align:center;">세부 내용</h2>
        <textarea class="form-control" rows="40" name = "description" style = "width:100%; background-color:#FFF; border:0" readonly>{{ $d_page->content}}></textarea>
        <br>
        <h2 style = "text-align:center;">추가 내용</h2>
        <textarea class="form-control" rows="7" style = "width:100%; background-color:#868ㄷ96; border:0" readonly>{{ $d_page->subcontent }}</textarea>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10"> 
                    <a href = "/design_board" style = "color:white;"><button type="button" class="btn btn-info">돌아가기</button></a>
                </div> 
            </div>
            <?php
            }
        ...
        <div id="div-right-sh">
        <blockquote>
          <p>추천 디자이너들의 게시글 입니다.</p>
          <footer>다양한 디자인과 디자이너들을 <cite title="Source Title">추천 받아보고 디자인 요청을 해보세요!</cite></footer>
          <footer>그림을 누르면 해당 게시글로 넘어갑니다.</footer>
        </blockquote>
        <?php 
        ...
        ?>
            ...
            <a href = "{{ route('design_read', ['d_page' => $rank[$i]]) }}">
                <img class="jumbotron" src="/design_image/<?php echo $rank[$i]?>/main_image.jpg" alt="..."style = "width:350px; 
                height:370px;background-color:#FFFFFF;float:left;margin-left:20px;" onerror="this.onerror=null; 
                this.src='/board_image/default_image.jpg';"   >
            </a>
