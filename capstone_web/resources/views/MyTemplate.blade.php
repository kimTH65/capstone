...
if($user2 = DB::table('image_template_tables')->where('user_id', $id)->first())
{
...
@section('contents')
    ...
    <div class="container marketing" style="min-height:1000px;" >
        ...
        <script>
           /* $(function() 
            ...
            function Basetem()
            {
                ...
                var check_id2 = '<?php echo $user_id2?>';
                ...
                if(id == check_id)
                {
                    ...
                    str +=  "<a href = '/template_page/myTemplate1'>";
        ...
        if(id == check_id2)
                {
                    ...
                    str +=  "<button type='submit' style = 'margin-left:5px;margin-bottom:5px;background-color:#01DFA5; width:100%;border:none;'class='btn btn-primary'>대표 연락처로 설정</button>";
                    //str +=  "<a href = template_page/TemplatePage/Mytemplate"+i+".php>";
                    str +=  "<a href = '/template_page/myTemplate2'>";
                    str += "<img src='template/img_im1.jpg' alt = template/img_tem1.jpg style = 'width:250px; height:420px;'></img></a>";
                    str +=  "<input type='hidden' name='_token' value='{{ csrf_token() }}'>";
                    str +=  "<input type='hidden' id = 'base_number' name='base_number' value='img_im1.jpg'>";
                    str +=  "<input type='hidden' id = 'base_im'  name='base_im' value='img'>";
                    str +=  "<input type='hidden' id = 'base_id'  name='base_id' value="+id+">";
                    str +=  "</div>";
                    str +=  "</form>";
                    document.getElementById("Basetem").innerHTML = str;
        ...
        <div id = "MyRepre">
            ...
            ?>
                <button type='submit' style = 'margin-left:5px;margin-bottom:5px;background-color:#01DFA5; width:100%;border:none;'class='btn btn-primary' disabled>대표 연락처</button>
            <img src='template/<?php echo $img_name ?>' alt = template/img.jpg style = 'width:250px; height:420px;'></img>
                <?php
                }
            ?>
    </div>
