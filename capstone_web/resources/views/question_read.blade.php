  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <hr>
        ...
        <br><br><br><br>
        <div style="width:100%;">
        <form action = "/q_comment_process" method = "POST" class="form-horizontal" role="form"  enctype="multipart/form-data" style="width:100%;"> 
            {{ csrf_field() }}
            <div class="form-group"> 
                <label for="title" class="col-sm-2 control-label">제목</label> 
                 <div class="col-sm-10"> 
                 <input type="text" class="form-control" name = "title" style="width:70%; background-color:white;" id="title" readonly value = {{ $q_page->title }}>
                </div> 
            </div> 
            ...
            <div class="form-group"> 
                 <label for="user" class="col-sm-2 control-label">작성자</label>
                    <div class="col-sm-10"> 
                     <input type="text" class="form-control" name = "user" style = "width : 40%;"id="user" readonly value = {{ $q_page->user_id }}>
                    </div>
            </div>
            ...
            <div class="form-group"> 
                 <label for="author" class="col-sm-2 control-label">내용</label>
                    <div class="col-sm-10"> 
                    <textarea class="form-control" rows="20" name = "description" style = "width:90%; background-color:white;" readonly>{{ $q_page->content }}</textarea>
                    </div>
            </div>
        ...
        <?php }?>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10"> 
                    <a href = "/question_board" style = "color:white;"><button type="button" class="btn btn-info">돌아가기</button></a>
                </div> 
            </div>
            <?php
            }
