...
@section('contents')
    ...
    <div class="container marketing" style="min-height:1000px;">
        <p style="font-size:4rem; font-weight:bolder;text-align:center; width:100%;">디자인 요청 상황</p>
    <img src="main_img/design_sta.jpg" alt = "다지인요청이미지" style = "width:100%;"><br><br>
