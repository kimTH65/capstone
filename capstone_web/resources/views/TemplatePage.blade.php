           ...
           /* $(function() 
            ...
            function AllTem()
            {
                ...
                var Imgcount = 6;
                    ...
                    {
                        str +=  "<div id = 'jb-imagebox' style = 'margin-left:80px;'>";
                        str +=  "<a href = /template_page/TemplatePage_Image"+i+">";
                        str += "<img src=template/img_im"+i+".jpg alt = template/img_im"+i+".png style = 'width:250px; height:450px;'></img></a>";
                        str +=  "</div>";
